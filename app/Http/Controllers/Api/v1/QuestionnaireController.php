...
//        }
        ...
        $keys = [
            'Честность', 'Границы', 'Ценности', 'Стиль жизни', 'Мотив', 'Атмосфера', 'Секс',
            'Книги', 'Друзья', 'Досуг', 'Эмоц. близость', 'Семейные роли', 'Доминантность',
            'Зависимость от мнения', 'Интересы', 'Язык любви', 'Психотипы', 'Решение конфликтов',
            'Порядок в быту', 'Планирование', 'Ссоры и темперамент'
        ];
        $c = 0;
        foreach ($testResult as $key=>$item) {
