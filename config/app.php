    ...
    'questionnaire' => [
        ...
        'value' => [
            ...
            'personal_qualities_partner' => [
                ['calm', 'energetic', null],
                ['happy', 'modest', null],
                ['purposeful', 'weak-willed', null],
                ['self', 'dependent', null],
                ['feminine', 'courageous', 'confident', null],
                ['delicate', 'live_here_now', null],
                ['pragmatic', 'graceful', null],
                ['sociable', 'smiling', null],
                ['housewifely', 'ambitious', null],
                ['artistic', 'good', null],
                ['aristocratic', 'stylish', null],
                ['economical', 'business', null],
                ['sports', 'fearless', null],
                ['shy', 'playful', null],
            ],
            'partner_information' => [
